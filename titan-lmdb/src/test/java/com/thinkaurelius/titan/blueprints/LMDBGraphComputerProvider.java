...
public class LMDBGraphComputerProvider extends AbstractTitanGraphComputerProvider {

    @Override
    public ModifiableConfiguration getTitanConfiguration(String graphName, Class<?> test, String testMethodName) {
        ModifiableConfiguration config = LMDBStorageSetup.getLMDBConfiguration(StorageSetup.getHomeDir(graphName));
